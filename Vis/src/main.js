...
height = innerHeight/1.5 - margin.top - margin.bottom
dataStore = {},
displayDims = [],
...
function buildControls(data) {
    ...
    d3.select("#dimensions").selectAll("myAxis")
        .data(dims)
        .enter()
        .append("div")
...
function buildLegend(data) {
    ...
    legend.selectAll("mylabels")
        ...
        .enter()
        .append("text")
            .attr("x", function(d,i){ return i*(3+50)})
            .attr("y", 45)
            .text(function(d){ return d})
    ...
    let xPos = members.length == 2 ? 30 : 55
    legend.selectAll("mydots")
        .data(members)
        .enter()
        .append("g")
        .append("rect")
            .attr("x", function(d,i){ return i*(3+50) + 6})
            .attr("y", 10)
            .attr("width", "20")
            .attr("height", "20")
